...
# Adapté à VSCode4 (générateur deck OHC) — porté de VSCode1 le 2026-07-24 (veille pratiques providers, chantier 1).
_WATCHED_PREFIXES = ("scripts/",)

# Signaux d'une vraie exécution de vérif dans la session (commandes Bash / skills).
_VERIF_BASH = ("pytest", "-m pytest", "test_generate_deck_ohc")
