...
> **Provenance** : document repris tel quel du projet frère VSCode2 le 2026-07-21, en
> même temps que la config d'installation d'`agent-orchestrator`/`agent-supervisor`
> (cf. `VSCode2/export/README.md` §7). Toutes les dates, incréments et précédents cités
> ci-dessous (« incrément A réalisé le 2026-07-17 », etc.) appartiennent à l'historique
> de VSCode2, conservés comme référence de conception — ce n'est pas le journal de ce
> projet-ci, qui démarre son propre suivi à partir de maintenant.
>
